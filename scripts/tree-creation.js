function init(id) {
  ...
  function textStyle() {
    return { font: "9pt  Segoe UI,sans-serif", stroke: "#18222e" };
  }

  // This converter is used by the Picture.
  function findHeadShot(key) {
    return "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/European_otter_02.jpg/640px-European_otter_02.jpg";
  }
  ...
  myDiagram.linkTemplate = $(
    ...
    $(go.Shape, { strokeWidth: 1, stroke: "#18222e" })
  ); // the link shape
